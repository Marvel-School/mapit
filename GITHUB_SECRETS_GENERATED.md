...
```
SSH_USER=deploy
PRODUCTION_HOST=YOUR_DIGITALOCEAN_SERVER_IP
...
**Public Key for Server (save this for step 3):**
```
...
## ✅ Next Steps:
1. Create DigitalOcean droplet and note the IP address
2. Add all secrets above to GitHub → Settings → Secrets and variables → Actions
3. Update PRODUCTION_HOST with your server IP
4. Update SSH_PRIVATE_KEY with your private key content
5. Update email configuration with your SMTP details
6. Set up domain DNS to point to your server
