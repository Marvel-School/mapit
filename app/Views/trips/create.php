        ...
        <div class="col-lg-10 mx-auto">
            <div class="card border-0 shadow">
                <div class="card-header bg-white py-3">
                    <h4 class="mb-0">Create New Trip</h4>
                </div>
                <div class="card-body">
                    <form action="/trips" method="POST">
                        ...
                        <p class="text-muted small">Add destinations to your trip itinerary.</p>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="tripDestinations" class="list-group mb-3">
                                ...
                                <div class="text-center py-3 empty-state" id="noDestinationsMessage">
    ...
    function updateMap() {
        ...
        if (selectedDestinations.length > 1) {
            ...
            const destination = new google.maps.LatLng(
                selectedDestinations[selectedDestinations.length - 1].latitude,
                selectedDestinations[selectedDestinations.length - 1].longitude
            );
            ...
            directionsRenderer.setDirections({routes: []});
            map.setCenter({lat: selectedDestinations[0].latitude, lng: selectedDestinations[0].longitude});
            map.setZoom(10);
        }
    }
